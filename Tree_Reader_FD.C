...
void Tree_Reader_FD(){
  ...
  TFile *f = new TFile("skim4_Tree_FD.root");
  ...
  TFile fileOutput1("Analysis_FD.root","recreate");

  //Creating histograms
  //PID only cut
  auto* hmiss_1=new TH1F("miss_1","MM(e' K^{+});P [GeV];Counts",400,-1,4);
  auto* hmiss_2=new TH1F("miss_2","MM^2(e' K^{+} p);P [GeV];Counts",400,-0.05,0.09);
  auto* hmiss_3=new TH1F("miss_3","MM(e' K^{+} K^{+});P [GeV];Counts",300,0,3);
  auto* hmiss_4=new TH1F("miss_4","MM^2(e' K^{+} K^{+} p);P [GeV];Counts",400,-0.4,0.3);
  auto* hmiss_5=new TH1F("miss_5","MM(e' K^{+} K^{+} K^{+});P [GeV];Counts",400,-1,3);
  auto* hmiss_6=new TH1F("miss_6","MM(e');P [GeV];Counts",400,-10.5,0);
  auto* hmiss_7=new TH1F("miss_7","MM(B - e');P [GeV];Counts",400,-10.5,0);
  ...
  auto* hmiss_2c=new TH1F("miss_2c","MM^2(e' K^{+} p) after cuts on delta beta and momentum of K^{+}; [GeV];Counts",400,-0.05,0.09);
  auto* hmiss_3c=new TH1F("miss_3c","MM(e' K^{+} K^{+}) after cuts on delta beta and momentum of K^{+}; [GeV];Counts",300,0,3);
  auto* hmiss_4c=new TH1F("miss_4c","MM^2(e' K^{+} K^{+} p) after cuts on delta beta and momentum of K^{+}; [GeV];Counts",400,-0.4,0.3);
  auto* hmiss_5c=new TH1F("miss_5c","MM(e' K^{+} K^{+} K^{+}) after cuts on delta beta and momentum of K^{+}; [GeV];Counts",400,-5,5);
  auto* hmiss_6c=new TH1F("miss_6c","MM(e');P [GeV] after cuts on delta beta and momentum of K^{+};Counts",400,-10.5,0);
  auto* hmiss_7c=new TH1F("miss_7c","MM(B - e') after cuts on delta beta and momentum of K^{+};P [GeV];Counts",400,-10.5,0);

  //missing mass cuts as well
  auto* hmiss_1t=new TH1F("miss_1t","MM(e' K^{+}) after cuts on delta beta and momentum of K^{+} and MM^2(e' K^{+} p) cut); [GeV];Counts",400,-1,4);
  auto* hmiss_2t=new TH1F("miss_2t","MM^2(e' K^{+} p) after cuts on delta beta and momentum of K^{+} and MM(e' K^{+}) cut); [GeV];Counts",400,-0.05,0.09);
  ...
  auto* hmiss_4t=new TH1F("miss_4t","MM^2(e' K^{+} K^{+} p) after cuts on delta beta and momentum of K^{+} and MM(e' K^{+} K^{+}) cut); [GeV];Counts",400,-0.4,0.3);
    ...
    if (i % 1000 == 0){
      ...
      for(Int_t j=0; j<Nparticles; j++){
        ...
        if(PID->at(j)==11){
          ...
          vt_kp = (time-(path/((3*10^8)*beta_tof_kp)));
      ...
      vt_pip = (time-(path/((c)*beta_tof_pip)));
      ...
      vt_pim = (time-(path/((c)*beta_tof_pim)));
      ...
      miss3 = (TLorentzVector)*readbeam + (TLorentzVector)*readtarget - el;
      miss4 = (TLorentzVector)*readbeam - el;
      l0 = pr + pim;
      ...
      if(readkaonpno==2 && readelno==1 && readprotonno==1){
          ...
          if(abs(v_delta_beta_kp[0])<0.01 && v_P_kp[0]>0.2  && abs(v_delta_beta_kp[1])<0.01 && v_P_kp[1]>0.2 && abs(delta_beta_pr)<0.01 && P_pr>0.2){
            ...
            if(miss4.M2()>0)hmiss_3t->Fill(miss3.M());
